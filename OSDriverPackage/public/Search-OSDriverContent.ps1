...
function Search-OSDriverContent {
    ...
    Get-ChildItem "$Path" -Recurse -Include $Files -File | Select-String $FindText | Select-Object Path, Filename, LineNumber, Line | Out-Gridview -Title 'Search-OSDriverContent Results'
}